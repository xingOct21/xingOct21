...
<p align="left">
  <img src="https://img.shields.io/badge/Claude-fff800?logo=anthropic" />
  <img src="https://img.shields.io/badge/ChatGPT-10a37f?logo=openai" />
  <img src="https://img.shields.io/badge/GitHub_Copilot-1e90ff?logo=github" />
  <img src="https://img.shields.io/badge/Zapier-ff4f00?logo=zapier" />
  <img src="https://img.shields.io/badge/n8n-e535ab?logo=n8n" />
...
- 🌀 Exploring the future of AI-empowered productivity
- 🤖 Power user of Claude, ChatGPT, Copilot and every trending AI tool
- 🧩 Building workflows by integrating open-source projects and skills — almost zero code!
- 🌐 Broad exposure to nearly all mainstream languages & frameworks (Python, JS, Go, Rust, Java, C#, TypeScript, Node.js, React, Vue, and more)
- 🔭 Always hacking on new ways to automate everything

---

## 🛠️ Tech Exposure & Quick-Build Skills
...
### [TRIAD – Tri-modal Reasoning for Interrogation And Deception](https://github.com/xingOct21/TRIAD-Tri-modal-Reasoning-for-Interrogation-And-Deception)
A cutting-edge multimodal deception detection system that leverages AI to analyze and reason with text, audio, and visual data for advanced interrogation and deception analysis.

### [StockRadar–Release](https://github.com/xingOct21/StockRadar--Release)
Automates the crawling of stock-related news and media, analyzes information via AI models, and predicts the impact of news on the stock market — an intelligent, hands-free stock volatility radar.
